...
public class ProgressBar extends View {
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        roundColor=typedArray.getColor(R.styleable.JMRoundProgressBar_ProundColor, Color.GRAY);
        roundProgressColor=typedArray.getColor(R.styleable.JMRoundProgressBar_ProundProgressColor,Color.RED);
        textColor=typedArray.getColor(R.styleable.JMRoundProgressBar_PtextColor,Color.RED);

        roundWidth= (int) typedArray.getDimension(R.styleable.JMRoundProgressBar_ProundWidth, 10);
        textSize = (int) typedArray.getDimension(R.styleable.JMRoundProgressBar_PtextSize, 40);

        max = typedArray.getInteger(R.styleable.JMRoundProgressBar_Pmax, 100);
